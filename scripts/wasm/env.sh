...
WASM_KEEP_SYMBOLS="${WASM_KEEP_SYMBOLS:-0}"
WASM_KEEP_SYMBOLS_CFLAGS="${WASM_KEEP_SYMBOLS_CFLAGS:--g2}"
WASM_KEEP_SYMBOLS_LDFLAGS="${WASM_KEEP_SYMBOLS_LDFLAGS:--gsource-map --profiling-funcs}"
...
export WASM_KEEP_SYMBOLS
export WASM_KEEP_SYMBOLS_CFLAGS
export WASM_KEEP_SYMBOLS_LDFLAGS
...
WASM_KEEP_SYMBOLS_CFLAGS=$WASM_KEEP_SYMBOLS_CFLAGS
WASM_KEEP_SYMBOLS_LDFLAGS=$WASM_KEEP_SYMBOLS_LDFLAGS
